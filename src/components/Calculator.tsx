...
export function Calculator({ onSave, initial, loadedFrom }: CalculatorProps) {
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/60">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <NumberField
              ...
              onChange={(v) => set('precoFilamentoKg', v)}
            />
            <NumberField
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/60">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <NumberField
              ...
              help="Depreciação e manutenção do equipamento"
            />
            <NumberField
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/60">
            ...
            <CostBreakdownBar
              ...
              segments={[
                ...
                { label: 'Desgaste', value: result.custoDesgaste, colorClass: 'bg-orange-400' },
            ...
            <dl className="mt-4 divide-y divide-slate-100 text-sm dark:divide-slate-800">
              ...
              {result.custoDesgaste > 0 && <Row label="Desgaste da impressora" value={result.custoDesgaste} />}
